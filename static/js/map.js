  ...
  restaurants.forEach((restaurant) => {
    ...
    button.onclick = function () {
      ...
      document.querySelector('input[name="location"]').value =
        restaurant.location_string || "Unknown City";
      document.querySelector('textarea[name="notes"]').value =
        restaurant.web_url || "No website available";
    };
  ...
  attractions.forEach((attraction) => {
    ...
    button.onclick = function () {
      document.querySelector('input[name="activity"]').value =
        attraction.name || "";
      document.querySelector('input[name="location"]').value =
        attraction.location_string || "Unknown City";
      document.querySelector('textarea[name="notes"]').value =
        attraction.web_url || "No website available";
    };
    sendToItineraryCell.appendChild(button);
    row.appendChild(sendToItineraryCell);
    ...
    const marker = new google.maps.Marker({
      ...
      icon: {
        url: item.photo
          ...
          : "https://maps.google.com/mapfiles/ms/icons/restaurant.png", // Use a default icon if no photo available
...
function initMap() {
  ...
  autocomplete.addListener("place_changed", function () {
    ...
    const showAttractions =
      document.getElementById("toggleAttractions").checked;

    if (showAttractions) {
      fetchAttractions(bl.lat(), tr.lat(), bl.lng(), tr.lng()).then(
        (attractions) => {
      ...
      fetchRestaurants(bl.lat(), tr.lat(), bl.lng(), tr.lng()).then(
        (restaurants) => {
  ...
  document
    .getElementById("toggleAttractions")
